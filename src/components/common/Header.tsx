...
function Header() {
  return (
    <>
      <div className="nav-v2 nav-v2-theme-cream" data-site-nav-v2>
        <div className="nav-v2__dark-overlay" />
        <div className="nav-v2__wrapper">
          ...
          <nav className="nav-v2-main" role="navigation" data-nav-v2-mobile>
            <div className="nav-v2-main__wrapper">
              <ul className="nav-v2-main__list">
                ...
                <li className="nav-v2-main__item">
                  <a data-nav-event-clicked="Jobs" href="/jobs">
                    Jobs
                  </a>
                </li>
                <li className="nav-v2-main__item">
          ...
          >
            <div className="nav-v2-dynamic__logged-out">
              ...
              <a
                className="nav-v2-dynamic__login"
